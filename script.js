...
// Tambahan fitur tombol menghindar
...
btnEnggak.addEventListener("mouseover", lari);
btnEnggak.addEventListener("touchstart", (e) => { e.preventDefault(); lari(); });
